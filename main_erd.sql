...
CREATE TABLE PRODUCTS (
    ...
    P_CATEGORY_DETAILS_ID BIGINT NOT NULL COMMENT '카테고리 상세 ID',
    FOREIGN KEY (P_CATEGORY_DETAILS_ID) REFERENCES PRODUCT_CATEGORY_DETAILS(P_CATEGORY_DETAILS_ID)
);

-- Cart Table
CREATE TABLE CARTS (
    CART_ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'CARTS MAIN KEY',
...
CREATE TABLE ORDERS (
    ...
    ORDER_STATUS ENUM('PENDING', 'CONFIRMED', 'PREPARING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'RETURN', 'EXCHANGE') NOT NULL DEFAULT 'PENDING' COMMENT '주문상태',
